...
public class ComplexTest {
    ...
    @Test
    void testEquals() {
        assertEquals(false, Complex.ZERO.equals(Complex.ONE));
        assertEquals(true, new Complex(0, 0).equals(new Complex(0, 0)));
        assertEquals(false, new Complex(0, 0).equals(new Complex(0, 1)));

    }

    @Test
    void testReal() {
        assertEquals(new Complex(3, 0), new Complex(real, 0).real(3));
        // assertEquals(new Complex(2, 0), new Complex(real,0).real(3));
        assertEquals(new Complex(-3, 0), new Complex(real, 0).real(-3));
    ...
    @Test
    void testModulus() {
        assertEquals(5, new Complex(5, 0).modulus());
        assertEquals(6, new Complex(-6, 0).modulus());
    }
    @Test
    void testScale() {
        assertEquals(new Complex(4, 4), new Complex(2, 2).scale(2));
        //assertEquals(new Complex(3, 4), new Complex(2, 2).scale(2));
        assertEquals(new Complex(-4, 4), new Complex(-2, 2).scale(2));

    }
    @Test
    void testMultiply() {
        assertEquals(new Complex(12, 16), new Complex(4, 2).multiply(new Complex(4, 2)));
